...
/**
 * Servlet implementation class wh_register
 */
@WebServlet("/wh_register")
public class wh_register extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			String qur="insert into wh_register values(?,?,?,?)";
			...
			if(i>0) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("wh_register.html");
				rd.include(request, response);
			}
		}catch(Exception e) {
